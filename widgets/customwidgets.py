...
class ThemedLabel(tk.Label):
	def __init__(self,frame,text="",font=smalltext,text_variable=None,background = color_1,foreground=lg,anchor="w",wraplength = None):
...
class ThemedListbox(tk.Listbox):
	def __init__(self,frame, foreground = lg, highlightthickness = 0, background = color_1, font = largetext, borderwidth = 0):
